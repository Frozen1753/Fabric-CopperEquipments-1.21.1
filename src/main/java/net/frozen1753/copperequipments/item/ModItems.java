...
import net.frozen1753.copperequipments.item.custom.*;
...
public class ModItems {
    ...
    public static final Item COPPER_SWORD = registerItem("copper_sword",
            new CopperSwordItem(ModToolMaterials.COPPER,
                    new Item.Settings()
    ...
    public static final Item COPPER_PICKAXE = registerItem("copper_pickaxe",
            new CopperPickaxeItem(ModToolMaterials.COPPER,
                    new Item.Settings()
    ...
    public static final Item COPPER_SHOVEL = registerItem("copper_shovel",
            new CopperShovelItem(ModToolMaterials.COPPER,
                    new Item.Settings()
    ...
    public static final Item COPPER_AXE = registerItem("copper_axe",
            new CopperAxeItem(ModToolMaterials.COPPER,
                    new Item.Settings()
    ...
    public static final Item COPPER_HOE = registerItem("copper_hoe",
            new CopperHoeItem(ModToolMaterials.COPPER,
                    new Item.Settings()
