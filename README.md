...
## 🔧 What’s in the Mod?
![Copper_Equipments_Banner.PNG](Copper_Equipments_Banner.PNG)
...
- 📦 **Loot Tables**: Most items can now be found in chests or obtained through trades.
...
1. Requires **Minecraft 1.21.1** (**+1.21.1** needs to be tested).
2. Requires **Fabric Loader** and **Fabric API**.
3. Drop the mod `.jar` file into your `mods/` folder.

Also available on [Modrinth](https://modrinth.com/mod/copper-equipments).

## 📜 License

Released under the MIT License. You’re free to use, modify, and share — just credit **Frozen1753**.
